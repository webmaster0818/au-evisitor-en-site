  ...
  return (
    <div className={`cta-sticky-bar${shown ? ' is-shown' : ''}`} aria-hidden={!shown}>
      <div className="cta-sticky-inner">
        <div>
          <p className="cta-sticky-title">Apply for your eVisitor — {F.fee}, no application charge</p>
          <p className="cta-sticky-sub">Official Department of Home Affairs website · independent guide</p>
        </div>
        <a
          href={F.officialUrl}
          target="_blank"
